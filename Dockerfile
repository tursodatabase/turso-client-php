# Dockerfile to create an image with PHP 8.5, PHP 8.5-dev, and Rust
...
# Install php8.5 and php8.5-dev.
# php8.5-dev includes development files for PHP, useful for compiling extensions.
